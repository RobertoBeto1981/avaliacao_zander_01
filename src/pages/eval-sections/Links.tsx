...
export function LinksFields({
  ...
  const disableForAvaliadorField = isProfessor && !isAvaliador
  ...
  return (
    <Card className="border-border/50">
      ...
      <CardContent className="space-y-6 animate-fade-in">
        <fieldset disabled={disableForAvaliadorField} className="grid md:grid-cols-2 gap-6">
          <FInput
        ...
        <div className="grid md:grid-cols-2 gap-6 pt-4 border-t border-border">
          <div className="space-y-1 relative group">
            <FTextarea
              ...
              disabled={disableForAvaliadorField}
            />
            {disableForAvaliadorField && (
          ...
          <div className="space-y-1 relative group">
            <FTextarea
              ...
              className="min-h-[120px]"
              disabled={isAvaliador && !isProfessor}
            />
            {isAvaliador && !isProfessor && (
              <div className="absolute top-8 right-2 text-[10px] text-muted-foreground flex items-center gap-1 bg-muted/80 backdrop-blur-sm px-2 py-1 rounded-md border border-border/50">
